...
belfoldi_jarat = BelfoldiJarat(1234, "Budapest", 10000, "2025-11-05 13:40", False)
nemzetkozi_jarat1 = NemzetkoziJarat(1235, "Isztambul", 40000, "2025-11-05 13:40", False)
nemzetkozi_jarat2 = NemzetkoziJarat(4567, "Isztambul", 200000, "2025-12-30 23:15", True)
...
legitarsasag.jegy_foglalasa("Budapest", "2025-11-05 13:40")
legitarsasag.jegy_foglalasa("Isztambul", "2025-12-30 23:15")
legitarsasag.jegy_foglalasa("Isztambul", "2025-12-30 23:15")
legitarsasag.jegy_foglalasa("Budapest", "2025-11-05 13:40")
legitarsasag.jegy_foglalasa("Isztambul", "2025-12-30 23:15")
legitarsasag.jegy_foglalasa("Isztambul", "2025-12-30 23:15")
